        ...
        <tr>
          <td style="padding:0 24px;">
            <div style="${borderTop}padding:10px 0;background:#F9FAFB;font-size:13px;color:#374151;line-height:1.6;font-family:${BRAND.font};">
              ${esc(ai.summary)}
              <span style="display:inline-block;float:right;color:${scoreColor};font-weight:600;font-size:12px;">${aiLabel} ${ai.value}</span>
            </div>
          </td>
        </tr>
      </table>`;
  ...
  <tr>
    ...
    for (const cat of zoneCats) {
      ...
      for (const item of cat.items) {
        const scoreBadge = item.value >= 9
          ? `<span style="display:inline-block;margin-left:6px;padding:1px 8px;background-color:#FEF3C7;border-radius:4px;font-size:11px;color:#B45309;font-weight:600;font-family:${BRAND.font};">必读</span>`
          : item.value >= 8
            ? `<span style="display:inline-block;margin-left:6px;padding:1px 8px;background-color:#E0E7FF;border-radius:4px;font-size:11px;color:#4338CA;font-weight:600;font-family:${BRAND.font};">推荐</span>`
            : '';
